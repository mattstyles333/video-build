...
from video_build.media import asset_id, fingerprint, iter_assets, probe, thumb_name
from video_build.timeline_view import compute_envelope, extract_frames, load_font
...
def render_video_contact_sheet(src: Path, duration: float, dest: Path, n: int = 4) -> bool:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        for fp, t in zip(frames, times, strict=True):
            try:
